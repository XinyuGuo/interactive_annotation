...
train_loss_l = []
val_loss_l = []
log_save_dir = '/data/ccusr/xinyug/annotation/Modified-3D-UNet-Pytorch/results/softdice_sim_points_one_time_batch'
if not os.path.exists(log_save_dir):
    os.mkdir(log_save_dir)

# model save path
check_points_save = '/data/ccusr/xinyug/annotation/Modified-3D-UNet-Pytorch/checkpoints/softdice_sim_points_one_time_batch'
...
clicks_info_train = sim_clicks_batch_v2.sim_clicks_dataset_batch(train_loader,clicks_info_init,model,num_points,sigma,device)
clicks_info_val_epoch = sim_clicks_batch_v2.sim_clicks_dataset_batch(val_loader,clicks_info_val_init,model,num_points,sigma,device)
