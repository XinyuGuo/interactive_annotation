from kidney_dataloader_1_c_aug_2_classes import KidneyDataset, KidneyDataset_standardization_2
from kidney_loss_factory import SoftDiceLoss_MultiClasses_Plus_CrossEntropy
...
log_save_dir = '/data/ccusr/xinyug/annotation/Modified-3D-UNet-Pytorch/results/softdice_kt_seg_1c_b6_r_aug_dicecross'
...
weight = torch.tensor([1.0,3.0,50.0]).to(device)
criterion = SoftDiceLoss_MultiClasses_Plus_CrossEntropy(weight, 0.000001)
optimizer = optim.SGD(model.parameters(), lr=0.001, momentum=0.9, weight_decay = 0.001)
check_points_save = '/data/ccusr/xinyug/annotation/Modified-3D-UNet-Pytorch/checkpoints/softdice_kt_seg_1c_b6_r_aug_dicecross'
