from kidney_dataloader_1_c_aug_2_classes import KidneyDataset, KidneyDataset_standardization
...
kidney_dataset_train = KidneyDataset_standardization(csv_train_path)
kidney_dataset_val = KidneyDataset_standardization(csv_val_path)
...
log_save_dir = '/data/ccusr/xinyug/annotation/Modified-3D-UNet-Pytorch/results/softdice_kt_seg_1c_b6_r_aug_kaiming'
...
check_points_save = '/data/ccusr/xinyug/annotation/Modified-3D-UNet-Pytorch/checkpoints/softdice_kt_seg_1c_b6_r_aug_kaiming'
