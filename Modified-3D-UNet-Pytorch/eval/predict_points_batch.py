...
# modelpath = '/data/ccusr/xinyug/annotation/Modified-3D-UNet-Pytorch/checkpoints/softdice_3_sim/checkpoint.pth.tar'
modelpath = '/data/ccusr/xinyug/annotation/Modified-3D-UNet-Pytorch/checkpoints/softdice_sim_points_one_time_batch/checkpoint_117_20200129_1435.pth.tar'
model = evaluate_tools.load_checkpoint_with_date(model, modelpath)

# simulate clicks
print('simulate clicks ...')
num_points = 3
clicks_info_val = sim_clicks_batch_v2.sim_clicks_dataset_batch(val_loader_init,clicks_info_val_init,model,num_points, sigma,device)
...
df_res.to_csv('results_without_largest_cc_3_channel.csv',index=False)
